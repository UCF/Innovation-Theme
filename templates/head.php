...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/gray.min.css" />
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/assets/js/vendor/jquery.gray.min.js"></script>
